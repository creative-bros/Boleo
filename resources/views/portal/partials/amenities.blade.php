...
<section class="section-stack">
    <div class="section-intro">
        <div>
            <p class="section-intro__eyebrow">Disponibilidad actual</p>
            <h3 class="section-intro__title">Amenidades registradas y reservas del dia</h3>
        </div>
        <p class="section-intro__note">Este bloque te permite distinguir de inmediato que areas existen, cual es su estado y que reservas siguen activas hoy.</p>
    </div>
